...
class Addapplication(models.Model):
    ...
    applinkweb = models.CharField(max_length=500, verbose_name='App Link web', null=True, blank=True)
    applink2 = models.CharField(max_length=500, verbose_name='Second App Link', null=True, blank=True)
